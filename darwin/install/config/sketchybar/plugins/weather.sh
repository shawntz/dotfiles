...
if [ -z $WEATHER_JSON ]; then
    ...
    /opt/homebrew/bin/sketchybar --set $NAME label=$LOCATION
    /opt/homebrew/bin/sketchybar --set $NAME.moon icon=
...
# /opt/homebrew/bin/sketchybar --set $NAME label="$LOCATION | $TEMPERATURE°F $WEATHER_DESCRIPTION"
/opt/homebrew/bin/sketchybar --set $NAME label="$TEMPERATURE°F $WEATHER_DESCRIPTION"
# /opt/homebrew/bin/sketchybar --set $NAME.moon icon=$ICON
